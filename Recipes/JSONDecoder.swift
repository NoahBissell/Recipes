...
class FetchData: ObservableObject {
    ...
    init(diet : String = "vegan"){
        guard let url = URL(string: (diet == "gluten" ? "https://api.spoonacular.com/recipes/complexSearch?apiKey=4753c32caf9640faa169ec11b07ad4fd&intolerances=\(diet)":"https://api.spoonacular.com/recipes/complexSearch?apiKey=be19bc5826a04fed982556734c3056b7&diet=\(diet)")) else {return}
...
class FetchRecipe: ObservableObject {
    ...
    init(name : Int = 716429){
        guard let url = URL(string:"https://api.spoonacular.com/recipes/\(name)/information?apiKey=6e1210515a994e818b19fb25a2319a23&includeNutrition=true") else {return}
