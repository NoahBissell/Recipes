...
class FetchData: ObservableObject {
    ...
    init(diet : String = "vegan"){
        guard let url = URL(string: (diet == "gluten" ? "https://api.spoonacular.com/recipes/complexSearch?apiKey=4753c32caf9640faa169ec11b07ad4fd&intolerances=\(diet)":"https://api.spoonacular.com/recipes/complexSearch?apiKey=4753c32caf9640faa169ec11b07ad4fd&diet=\(diet)")) else {return}
...
class FetchRecipe: ObservableObject {
    ...
    init(name : Int = 716429){
        guard let url = URL(string:"https://api.spoonacular.com/recipes/\(name)/information?apiKey=4753c32caf9640faa169ec11b07ad4fd&includeNutrition=true") else {return}
